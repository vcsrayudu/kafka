...
public class SwaggerConfig {
	private static final String SERVICE_TITLE = "KafkaOrderCassandra";
	private static final String SERVICE_DESCRIPTION = "Order Service with cassandra database and Kafka web service";
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).useDefaultResponseMessages(false).select()
				.apis(RequestHandlerSelectors.basePackage("com.ot.micropay.order.controller"))
