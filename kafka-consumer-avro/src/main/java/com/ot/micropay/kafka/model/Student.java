...
public class Student extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3362732071239120983L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Student\",\"namespace\":\"com.ot.micropay.kafka.model\",\"fields\":[{\"name\":\"studentName\",\"type\":\"string\"},{\"name\":\"studentId\",\"type\":\"string\"},{\"name\":\"age\",\"type\":\"int\"}]}");
   ...
   */
  public static com.ot.micropay.kafka.model.Student.Builder newBuilder() {
    return new com.ot.micropay.kafka.model.Student.Builder();
  }
   ...
   * @return A new Student RecordBuilder
   */
  public static com.ot.micropay.kafka.model.Student.Builder newBuilder(com.ot.micropay.kafka.model.Student.Builder other) {
    return new com.ot.micropay.kafka.model.Student.Builder(other);
  }
   ...
   * @return A new Student RecordBuilder
   */
  public static com.ot.micropay.kafka.model.Student.Builder newBuilder(com.ot.micropay.kafka.model.Student other) {
    return new com.ot.micropay.kafka.model.Student.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Student>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.ot.micropay.kafka.model.Student.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.ot.micropay.kafka.model.Student other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.studentName)) {
        this.studentName = data().deepCopy(fields()[0].schema(), other.studentName);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ot.micropay.kafka.model.Student.Builder setStudentName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ot.micropay.kafka.model.Student.Builder clearStudentName() {
      studentName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ot.micropay.kafka.model.Student.Builder setStudentId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ot.micropay.kafka.model.Student.Builder clearStudentId() {
      studentId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ot.micropay.kafka.model.Student.Builder setAge(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ot.micropay.kafka.model.Student.Builder clearAge() {
